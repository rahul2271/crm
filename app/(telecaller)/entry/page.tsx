...
//                     {/* Consultation type — dropdown with all 4 types */}
//                     <div className="flex flex-col gap-1">
//                       <label className="text-xs font-medium text-gray-600">Type</label>
//                       <Controller control={control} name={`entries.${i}.consultationType`}
//                         render={({ field }) => {
...
//                               value={field.value}
//                               onChange={e => field.onChange(e.target.value)}
//                               className={`rounded-lg border px-2.5 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-brand-500 font-medium ${
                          ...
                          return (
                            <select
                              ...
                              className={`rounded-lg border px-2.5 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-brand-500 font-medium ${
                                ...
                                opt?.value === 'hospital' ? 'border-orange-300 text-orange-700' :
                                opt?.value === 'whatsapp' ? 'border-green-300 text-green-700'  :
                                opt?.value === 'call'     ? 'border-purple-300 text-purple-700' :
